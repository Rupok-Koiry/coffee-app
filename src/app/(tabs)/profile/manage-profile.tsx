            ...
            <TouchableOpacity onPress={pickImage}>
              <View className="bg-tertiary-background w-32 h-32 p-4 rounded-full mx-auto">
                ...
                >
                  ...
                  <View className="absolute bottom-0 right-0 bg-primary-text rounded-full p-2 shadow-lg">
                    <Ionicons
                      name="camera"
                      size={20}
              ...
              <Text className="font-poppins-semibold text-primary-text text-center mt-3">
